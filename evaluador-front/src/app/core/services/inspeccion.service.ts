...
export class InspeccionService {
  ...
  getAll(): Observable<Ingreso[]> {
    return this.http.get<Ingreso[]>(`${this.baseUrl}/inspeccion`);
  }
...
getByIdHttp(id: number): Observable<Ingresos> {
  return this.http.get<Ingresos>(`${this.baseUrl}/inspeccion/${id}`);
}
...
create(avaluo: Omit<Ingresos, 'id'>): Observable<Ingresos> {
  return this.http.post<Ingresos>(`${this.baseUrl}/inspeccion`, avaluo);
}
...
update(id: number, avaluo: Partial<Ingresos>): Observable<Ingresos> {
  return this.http.put<Ingresos>(`${this.baseUrl}/inspeccion/${id}`, avaluo);
}
  ...
  private mapToAvaluo(item: any): Ingreso {
    return {
      ...
      historicoPropietarios: item.historicoPropietarios || [],
